      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 pt-32 pb-16">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <motion.div className="text-center space-y-4" {...fadeInUp}>
            ...
            >
              Building beautiful, interactive experiences with code. Passionate about design, animation, and user
              experience.
            </motion.p>
            <motion.div
          ...
          {/* Featured Work Grid */}
          <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6" {...fadeInUp} transition={{ delay: 0.6 }}>
            {projects.map((project, index) => (
              <motion.div key={project.id} {...fadeInUp} transition={{ delay: 0.6 + index * 0.1 }}>
                <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
          ...
          {/* Hobbies Section */}
          <motion.div className="space-y-4" {...fadeInUp} transition={{ delay: 1.2 }}>
            ...
            <div className="flex justify-center gap-8">
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <Link
                  ...
                  className="text-center hover:text-primary transition-colors duration-300"
                >
